            ...
            pointerEvents: 'auto',
                ...
                boxShadow: '0 8px 32px rgba(0, 0, 0, 0.5)',
                        ...
                        marginBottom: '16px',
                                ...
                                fontWeight: 600,
                                color: '#7aa2f7',
                            }, children: "Rename" }), _jsx("button", { onClick: handleClose, style: closeButtonStyle, children: "\u2715" })] }), _jsxs("div", { style: {
                        fontSize: '13px',
                        color: '#565f89',
                        marginBottom: '12px',
                    }, children: ["Renaming: ", _jsx("span", { style: { color: '#a9b1d6' }, children: nodeLabel })] }), _jsx("label", { style: {
                        display: 'block',
                        fontSize: '13px',
                        color: '#a9b1d6',
                        marginBottom: '4px',
                        fontWeight: 500,
                    }, children: "New name" }), _jsx("input", { ref: inputRef, type: "text", value: draft, onChange: handleInputChange, onKeyDown: handleKeyDownInput, disabled: isSaving, style: {
                        ...inputStyle,
                    ...
                    }, children: [_jsx("button", { onClick: handleClose, disabled: isSaving, style: cancelButtonStyle, children: "Cancel" }), _jsx("button", { onClick: () => void handleSave(), disabled: isSaving, style: {
                                ...saveButtonStyle,
                                opacity: isSaving ? 0.5 : 1,
                                cursor: isSaving ? 'not-allowed' : 'pointer',
                            }, children: isSaving ? 'Renaming…' : 'Save' })] })] }) }));
}
/* ── Shared styles ──────────────────────────────── */
const inputStyle = {
    width: '100%',
