 ...
 */
export default function FileObject({ node, position }) {
    ...
    const handleContextMenu = useCallback((e) => {
        ...
        openContextMenu(e.nativeEvent.clientX, e.nativeEvent.clientY, node.id);
    ...
    return (_jsxs("mesh", { ref: meshRef, position: position, scale: [scale, scale, scale], geometry: getGeometry(shape), onPointerOver: handlePointerOver, onPointerOut: handlePointerOut, onClick: handleClick, onDoubleClick: handleDoubleClick, onContextMenu: handleContextMenu, frustumCulled: true, children: [_jsx("meshStandardMaterial", { color: color, emissive: color, emissiveIntensity: 0, roughness: 0.4, metalness: 0.1 }), hovered && (_jsx(Html, { distanceFactor: 15, position: [0, 1.2, 0], style: { pointerEvents: 'none' }, children: _jsxs("div", { style: {
